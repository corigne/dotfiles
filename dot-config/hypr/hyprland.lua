...
hl.on("config.reload",   ensure_procs)
...
hl.bind(mainMod .. " + CTRL + ESCAPE",  hl.dsp.exec_cmd("pkill wayland_slidesh; " .. scripts .. "/wayland_slideshow.sh ~/Pictures/slideshow " .. gowall_theme))
hl.bind(mainMod .. " + SHIFT + ESCAPE", hl.dsp.exec_cmd("pkill wayland_slidesh; " .. scripts .. "/wayland_slideshow.sh ~/Pictures/sfw " .. gowall_theme))
hl.bind(mainMod .. " + ALT + ESCAPE",   hl.dsp.exec_cmd("pkill wayland_slidesh; " .. scripts .. "/wayland_slideshow.sh ~/Pictures/animated_slideshow " .. gowall_theme))
...
hl.window_rule({ match = { class = "^org.mozilla.Thunderbird$", title = "^Write:\\s.+$" },            float = true, size = "1100 700" })
hl.window_rule({ match = { class = "^org.mozilla.Thunderbird$", title = "^(.*)(Reminders)(.*)$" },   float = true, size = "900 400" })
