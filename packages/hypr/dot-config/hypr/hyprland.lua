...
local lock_cmd        = "hypr-lock " .. gowall_theme
...
hl.plugin.load("/var/cache/hyprpm/nexus/hyprexpo/hyprexpo.so")
...
hl.bind(mainMod .. " + SHIFT + ESCAPE",
    hl.dsp.exec_cmd("awww-slideshow-control stop; awww-slideshow ~/Pictures/sfw " .. gowall_theme))
hl.bind(mainMod .. " + ALT + ESCAPE",
    hl.dsp.exec_cmd("awww-slideshow-control stop; awww-slideshow ~/Pictures/animated_slideshow " .. gowall_theme))

hl.bind(mainMod .. " + F1", hl.dsp.exec_cmd("hypr-gamemode"))
